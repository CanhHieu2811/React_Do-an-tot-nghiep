...
export const TICKETCRT = "/api/ticket/pre-booking"
export const TICKETDEL = "/api/ticket/delete"
export const TICKETDET = "/api/ticket/all-list"
export const TICKET = "/api/ticket"

export const NEWSALL = "/api/post/list"
export const NEWSCRT = "/api/post/create"
...
export const STATUSALL = "/api/status/list"